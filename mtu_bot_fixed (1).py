...
def _load_index():
    ...
    try:
        ...
        # This handles the case where a user manually uploaded a database.json to the channel
        logger.info("No pinned DB index — scanning recent messages for seed database...")
        try:
